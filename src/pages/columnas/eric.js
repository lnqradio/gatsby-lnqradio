...
const EricPage = () => {
  const data = useStaticQuery(graphql`
    query EricQuery {
      ...
      allContentfulAutores(filter: { name: { eq: "Eric" } }) {
        edges {
          node {
            id
            imagen {
        ...
        <section className="flex flex-col justify-center w-full">
          <div className="flex-col items-center md:flex-row flex w-full md:w-2/3 max-w-6xl p-8 m-auto bg-gray-900 md:my-12">
            ...
            <div className="text-3xl text-left px-3 pl-10 text-white m-0 w-full">
              <h1 className="text-white pb-3 mb-2 border-b">Eric</h1>
              <AnchorLink
                href={`#author-player`}
              ...
              <a
                href="https://open.spotify.com/search/lnqradio%20eric/episodes"
                target="_blank"
