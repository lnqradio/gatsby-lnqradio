      ...
      <div className="grid max-w-6xl grid-cols-1 gap-6 pb-12 mx-auto lg:grid-cols-2">
        ...
        >
          ...
          >
            <iframe
              ...
              frameBorder="no"
              allow="autoplay"
              src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1179438829&color=%23ff5500&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false&visual=true"
            ></iframe>
          </div>
          <div className="relative flex flex-col items-center justify-center px-4 pb-1">
            <h2 className="flex items-baseline w-full pt-2 text-3xl font-bold leading-normal text-left text-white uppercase">
        ...
        >
          ...
          >
            <iframe
              ...
              frameBorder="no"
              allow="autoplay"
              src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1145458177&color=%23ff5500&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false&visual=true"
            ></iframe>
          </div>
          <div className="relative flex flex-col items-center justify-center px-4 pb-1">
            <h2 className="flex items-baseline w-full pt-2 text-3xl font-bold leading-normal text-left text-white uppercase">
              <span className="flex-1">
                Capitulo 5 - Ciclo Lunar (Luna llena en Aries)
              </span>
            </h2>
          </div>
        </div>
        ...
        >
          ...
          >
            <iframe
              ...
              frameBorder="no"
              allow="autoplay"
              src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1134531235&color=%23ff5500&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false&visual=true"
            ></iframe>
          </div>
          <div className="relative flex flex-col items-center justify-center px-4 pb-1">
            <h2 className="flex items-baseline w-full pt-2 text-3xl font-bold leading-normal text-left text-white uppercase">
              <span className="flex-1">
                Capitulo 4 - Libra (venus En Escorpio)
              </span>
            </h2>
          </div>
        </div>
        ...
        >
          ...
          >
            <iframe
              ...
              frameBorder="no"
              allow="autoplay"
              src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1126500376&color=%23ff5500&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false&visual=true"
            ></iframe>
          </div>
          <div className="relative flex flex-col items-center justify-center px-4 pb-1">
            <h2 className="flex items-baseline w-full pt-2 text-3xl font-bold leading-normal text-left text-white uppercase">
              <span className="flex-1">
                Capítulo 3 - Los Retrogrados (una Caricia A Mercurio)
              </span>
            </h2>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative flex flex-col items-center justify-center px-4 pb-1">
            <h2 className="flex items-baseline w-full pt-2 text-3xl font-bold leading-normal text-left text-white uppercase">
              <span className="flex-1">
                Capítulo 2 - Eje Virgo/Piscis o las puertas de la percepción
              </span>
            </h2>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative flex flex-col items-center justify-center px-4 pb-1">
            <h2 className="flex items-baseline w-full pt-2 text-3xl font-bold leading-normal text-left text-white uppercase">
              <span className="flex-1">Capítulo 1 - Luna Nueva En Leo</span>
            </h2>
          </div>
        </div>
      </div>
